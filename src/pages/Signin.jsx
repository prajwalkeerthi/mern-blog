  ...
  return<div className="min-h-screen mt-20">
        <div className="flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-5">
            ...
            <p className="text-sm mt-5">
              This react project You can sign in with your email and password or with Google.
            </p>            
            </div>
            <div className="flex-1">
              {/*Right side */}
                <form className="flex flex-col gap-4" onSubmit={handleSubmit}>                 
                  ...
                  <TextInput type="email" placeholder="name@company@gamil.com" id='email'onChange={handleChange}/>
                  </div>
                  <div>
